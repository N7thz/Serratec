...
public class CreateDAO {
	...
	private static void criarEntidadePedidoItens(Conexao con, String schema) {
		...
		if (!entidadeExists(con, schema, entidade))		
			criarTabela(con, entidade, schema);
		if (entidadeExists(con, schema, entidade)) {
			criarCampo(con, schema, entidade, "id_pedido_itens", "integer", true , false, null, null);
			criarCampo(con, schema, entidade, "id_pedido" 	   , "integer", false, true	, schema + ".pedido", "id_pedido");
			criarCampo(con, schema, entidade, "id_produto"     , "integer", false, true	, schema + ".produto", "id_produto");
			criarCampo(con, schema, entidade, "quantidade"     , "integer", false, false, null, null);
		}		
	}
