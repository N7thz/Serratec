...
public class Main {
	...
	public static ListasProdutos produto;
	public static ListaClientes cliente;
	...
	public static void nossa_empresa() {
		...
		Empresa Grupo_1 = new Empresa("Grupo 1","12345678900","rua A","(21)94002-8922",dataHoraFormatada,"mC BURGER");
	...
	public static void cadastrarProduto() {
		...
		produto.adicionarProdutoLista(p);
	}
	...
	public static void cadastrarCliente() {
		...
		cliente.adicionarClienteLista(c);
