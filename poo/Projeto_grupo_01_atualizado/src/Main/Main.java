...
public class Main {
    ...
    public static void alterarEstoque() {
    	...
    	Item i = (Item) produtos.localizarProduto(Produto.localizarProduto
    			("Alteração de produto"));
    	        
        if(!(p == null)) {
        	Produto.atualizarEstoque(p);
        	ProdutoDML.alterarProduto(con, SCHEMA, p);
        }else
        	System.out.println("Produto não localizado!");
    ...
    public static void cadastrarPedido() {
        ...
        if (!(c == null)) {
        		Produto p = incluirProdutoPedido();
    ...
    public static Item incluirProdutoPedido() {
    	Scanner input = new Scanner(System.in);
		Produto p = produtos.localizarProduto(Produto.localizarProduto("Digite o id do produto: "));
    	Item i = new Item();
    	...
    	while (i == null) {
    		...
    		i = (Item) produtos.localizarProduto(Produto.localizarProduto("Digite o id do produto: "));
    	}
	...
	public static Produto atualizarEstoque(Produto p ,Item i) {
		Scanner input = new Scanner(System.in);
